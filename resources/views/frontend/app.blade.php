...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="public/theme/frontend/css/plugins.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="public/theme/frontend/css/main.css" />
...
<body>
                    ...
                    <div class="col-lg-4">
                        <ul class="header-top-list">
                            ...
                            <li class="dropdown-trigger language-dropdown"><a href=""><span class="flag-img"><img
                                            src="public/theme/frontend/image/icon/eng-flag.png" alt=""></span>en-gb </a><i
                                    class="fas fa-chevron-down dropdown-arrow"></i>
                                <ul class="dropdown-box">
                                    <li> <a href=""> <span class="flag-img"><img src="public/theme/frontend/image/icon/eng-flag.png"
                                                    alt=""></span>English</a></li>
                                    <li> <a href=""> <span class="flag-img"><img src="public/theme/frontend/image/icon/germany-flag.png"
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <a href="index.html" class="site-brand">
                                <img src="public/theme/frontend/image/logo.png" alt="">
                            </a>
                        </div>
                        <div class="col-lg-5">
                                            ...
                                            <div class=" single-cart-block ">
                                                <div class="cart-product">
                                                    <a href="product-details.html" class="image">
                                                        <img src="public/theme/frontend/image/products/cart-product-1.jpg" alt="">
                                                    </a>
                                                    <div class="content">
        ...
        <div class="footer-bottom">
            <div class="container">
                ...
                <a href="#" class="payment-block">
                    <img src="public/theme/frontend/image/icon/payment.png" alt="">
                </a>
    ...
    <!-- Use Minified Plugins Version For Fast Page Load -->
    <script src="public/theme/frontend/js/plugins.js"></script>
    <script src="public/theme/frontend/js/ajax-mail.js"></script>
    <script src="public/theme/frontend/js/custom.js"></script>
</body>
